...
public class ResponseTimeEquation extends AbstractOutputFunction implements IDifferentiableFunction {
	...
	protected ResponseTimeEquation(SystemModel system,
			List<Resource> selectedResources, List<Service> selectedClasses) {
...
//		cls_r = service;
//		
//		responseTimeQuery = QueryBuilder.select(Metric.RESPONSE_TIME).forService(service).average();
