 ...
 * <ul>
 *   <li>{@link net.descartesresearch.librede.configuration.impl.DataSourceImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.descartesresearch.librede.configuration.impl.DataSourceImpl#getConfiguration <em>Configuration</em>}</li>
 *   <li>{@link net.descartesresearch.librede.configuration.impl.DataSourceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataSourceImpl extends MinimalEObjectImpl.Container implements DataSource {
	...
	protected EClass eStaticClass() {
		return ConfigurationPackage.Literals.DATA_SOURCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.DATA_SOURCE__NAME, oldName, name));
	}
	...
	public EList<Parameter> getConfiguration() {
		if (configuration == null) {
			configuration = new EObjectContainmentEList<Parameter>(Parameter.class, this, ConfigurationPackage.DATA_SOURCE__CONFIGURATION);
		}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.DATA_SOURCE__TYPE, oldType, type));
	}
