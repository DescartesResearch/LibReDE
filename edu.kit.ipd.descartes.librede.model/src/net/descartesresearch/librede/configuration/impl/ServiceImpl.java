 ...
 * <ul>
 *   <li>{@link net.descartesresearch.librede.configuration.impl.ServiceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceImpl extends MinimalEObjectImpl.Container implements Service {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigurationPackage.SERVICE__NAME, oldName, name));
	}
