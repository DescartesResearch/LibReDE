...
//		precalculateFactorials(maxParallel);
	...
	/* (non-Javadoc)
	 * @see edu.kit.ipd.descartes.librede.estimation.models.observation.functions.IOutputFunction#getCalculatedOutput(edu.kit.ipd.descartes.linalg.Vector)
	 */
	@Override
...
//			double P_q = calculateQueueingProbability(p, U_i);
	...
	/* (non-Javadoc)
	 * @see edu.kit.ipd.descartes.librede.estimation.models.diff.IDifferentiableFunction#getFirstDerivatives(edu.kit.ipd.descartes.linalg.Vector)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.kit.ipd.descartes.librede.estimation.models.diff.IDifferentiableFunction#getSecondDerivatives(edu.kit.ipd.descartes.linalg.Vector)
	 */
	@Override
